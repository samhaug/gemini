...
def make_smooth_dict():
    ...
    smooth_dict[3]['h'] = R12
    m = (VS12-VS11)/(R12-R11)
    smooth_dict[3]['vs'] = (VS11,m)
    m = (RHO12-RHO11)/(R12-R11)
    smooth_dict[3]['rho'] = (RHO11,m)
    m = (VP12-VP11)/(R12-R11)
    smooth_dict[3]['vp'] = (VP11,m)
    ...
    smooth_dict[5]['h'] = R12
    m = (RHO12-RHO11)/(R12-R11)
    smooth_dict[5]['rho'] = (RHO11,m)
    m = (VP12-VP11)/(R12-R11)
    smooth_dict[5]['vp'] = (VP11,m)
    m = (VS12-VS11)/(R12-R11)
    smooth_dict[5]['vs'] = (VS11,m)
    ...
    smooth_dict[8]['h'] = R12
    m = (RHO12-RHO11)/(R12-R11)
    smooth_dict[8]['rho'] = (RHO11,m)
    m = (VP12-VP11)/(R12-R11)
    smooth_dict[8]['vp'] = (VP11,m)
    m = (VS12-VS11)/(R12-R11)
    smooth_dict[8]['vs'] = (VS11,m)
