...
Last Modified : Sun 09 Jul 2017 01:02:26 PM EDT
...
def main():
    ...
    plt.plot(6371.-param[:,0],param[:,1])
    plt.plot(6371.-param[:,0],param[:,2])
    plt.plot(6371.-param[:,0],param[:,3])
    plt.show()
...
def smooth_profile():
    ...
    for dist in range(6372):
        ...
        if dist >= 6346.6:
            ...
            mu_p=6.9254+1.4672*x-2.0834*x**2+.9783*x**3
            print dist
            param_list.append([dist,rho_p,lam_p,mu_p])
